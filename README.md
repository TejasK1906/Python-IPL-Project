...
This repository contains the thorough analysis of IPL 2022 data with the help of pandas and matplotlib library. The data was downloaded from Kaggle and with a bit of cleaning was made suitable for the analysis. It also contains the important insights and the conclusions which is evident form the analysis. For better understanding and visualisation of insights some of the analysis was also accompanied with charts.
